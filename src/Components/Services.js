...
const Features = () => {
  ...
  return (
    ...
    <b><h3>How Can We Help You Today?</h3></b>
      </p>
        ...
        <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                <h3 className="text-lg font-medium text-gray-900">Our Doctors</h3>
                <p className="text-sm text-gray-500">BDS | Surgeons | MBBS</p>
                <p className="text-lg font-bold text-gray-700 mt-4">Our Highly Trained Doctors</p>
                <button onClick={handleOpenDoctorManagement} className="mt-6 px-4 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-700">
                  Doctors
                </button>
              </div>
            </div>
          ...
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                <h3 className="text-lg font-medium text-gray-900">Hospital Facilites</h3>
                <p className="text-sm text-gray-500">Comfortable Beds | 24x7 Service | Nursing Staff Available</p>
                <p className="text-lg font-bold text-gray-700 mt-4">24x7 Service Available</p>
          ...
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                <h3 className="text-lg font-medium text-gray-900">Happy Patients</h3>
                <p className="text-sm text-gray-500">Caring | Rutine Checkup | Ambulance Service</p>
                <p className="text-lg font-bold text-gray-700 mt-4">We Care Our Patients</p>
                <button className="mt-6 px-4 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-700">
                  Patient
                </button>
              </div>
