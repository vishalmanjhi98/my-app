    ...
    <div id="demo" className="flex flex-col md:flex-row w-full h-screen bg-amber-800">
      <div className="w-full md:w-1/2 p-4 md:p-8 bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Our  <span className="text-amber-800">Hospital </span>Facilities</h1>
          <div className="aspect-w-16 aspect-h-9">
          <video style={{ width: "400px" }} className="w-full h-full" controls autoPlay muted>
